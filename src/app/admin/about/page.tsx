...
import { Plus, Edit2, Trash2, Search, Check, ArrowLeft, Info, FileText } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";

export default function AboutAdminPage() {
  const [entries, setEntries] = useState([
    { id: "1", title: "Company History", content: "Sankalp was founded in...", status: "Published" },
    { id: "2", title: "Our Mission", content: "To deliver premium...", status: "Published" },
  ]);
