...
export default function RentalCommercialAdminPage() {
  ...
  const fetchProperties = useCallback(async () => {
    setIsLoading(true);
    try {
      const res = await fetch("/api/rentals?type=commercial");
      const data = await res.json();
      setProperties(data);
    } catch (error) {
      console.error("Error fetching commercial rentals:", error);
        ...
        {!isFormOpen ? (
          <motion.div key="list" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h1 className="text-2xl font-bold text-gray-900 uppercase tracking-tight">Commercial Rentals</h1>
                <p className="text-gray-500 text-sm">Manage commercial properties for rent.</p>
              </div>
              <button 
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Enter the details for the commercial rental property.</p>
                </div>
              </div>
